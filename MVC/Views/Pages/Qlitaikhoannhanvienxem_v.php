                ...
                <?php if (!empty($data['dulieu']) && mysqli_num_rows($data['dulieu']) > 0): ?>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($data['dulieu'])): ?>
                        <tr>
                            ...
                            <td>
                                <a href="http://localhost/rapphim/Qlitaikhoannhanvienxem/sua/<?php echo urlencode($row['maNhanvien']); ?>" class="btnsua">
                                    <i class="fas fa-edit"></i> Sửa
                                </a>
                                <a href="http://localhost/rapphim/Qlitaikhoannhanvienxem/xoa/<?php echo urlencode($row['maNhanvien']); ?>" class="btnsua" onclick="return confirm('Bạn có chắc chắn muốn xóa tài khoản này?')">
